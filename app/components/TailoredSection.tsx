...
export default function TailoredSection() {
  return (
    <section className="w-[1104px] h-[686px] py-16 bg-white border-b border-gray-100 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col justify-center md:flex-row items-center gap-12">
     
          <div className="w-full md:w-[398px] h-[500px] md:h-[600px] relative rounded-lg overflow-hidden shadow-lg">
            <Image
          ...
          <div className="w-[1px] h-[450px] md:h-[450px] bg-gray-400"></div>
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-gray-600 font-bold leading-relaxed mb-8 max-w-md mx-auto md:mx-0">
              Experience the luxury of Rajputi Poshakhs tailored to your measurements—crafted with precision, grace, and artistry.
            </p>
